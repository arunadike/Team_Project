	...
	public void run(String... args) throws Exception {
		if (travelPackageRepository.count() == 0) {
			...
			List<TravelPackage> defaultPackages = Arrays.asList(
					new TravelPackage(0, "Paris Getaway", "Explore the city of lights", 5, 1500.0,
							"Flight, Hotel, Tour Guide", defaultUser, "assets/destination-1.jpg"),
					new TravelPackage(0, "Taj Mahal Tour", "Visit the iconic Taj Mahal", 3, 1200.0,
							"Flight, Hotel, Entry Tickets", defaultUser, "assets/destination-2.jpg"),
					new TravelPackage(0, "Beach Holiday", "Relax on the sunny beaches", 7, 1800.0,
							"Flight, Hotel, Beach Activities", defaultUser, "assets/destination-3.jpg"));
