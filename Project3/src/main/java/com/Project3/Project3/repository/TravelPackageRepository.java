...
public interface TravelPackageRepository extends CrudRepository<TravelPackage, Integer> {
    ...
    List<TravelPackage> findByTitleContainingIgnoreCaseAndDurationBetween(String title, Integer minDuration, Integer maxDuration);
    ...
    List<TravelPackage> findByDurationBetweenAndPriceBetween(Integer minDuration, Integer maxDuration, double minPrice, double maxPrice);
    ...
    List<TravelPackage> findByIncludedServicesAndPriceBetween(
            @Param("service") String service,
            @Param("delimiter") String delimiter,
    ...
    List<TravelPackage> findByTitleContainingIgnoreCaseAndDurationBetweenAndPriceBetween(
            String title, Integer minDuration, Integer maxDuration, double minPrice, double maxPrice);
    ...
    List<TravelPackage> findByTitleContainingIgnoreCaseAndIncludedServicesAndPriceBetween(
            @Param("title") String title,
            @Param("service") String service,
            @Param("delimiter") String delimiter,
            @Param("minPrice") double minPrice,
