...
function renderPackages(filteredPackages = []) {
  ...
  filteredPackages.forEach((pkg) => {
      ...
      function fetchAndRenderPackages(searchTitle = "", minDuration = null, maxDuration = null) {
          ...
          if (searchTitle) {
              urlParams.append('title', searchTitle); // Use append
          }
          if (minDuration !== null) {
          ...
          const finalUrl = apiUrl + (urlParams.toString() ? '?' + urlParams.toString() : ''); //  toString()
      ...
      $(document).ready(function () {
          ...
          $(".search-box input").on("input", function () {
              ...
              fetchAndRenderPackages(searchTerm, minDuration, maxDuration);
          });
